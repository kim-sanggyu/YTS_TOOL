...
export const MAPPING_2025: MappingRow[] = [
  ...
  { group: "그밖의소득공제", ntsCode: "8403", label: "청약저축",                ytsCol: "OTHER_8403", resultCol: "OTO_HOUSE_LOAN_SBSC_AMT", valueKey: "useAmt", rule: "value", status: "진행", send: true, note: "IN=PEN_SAVE_SPEC CLS 562-050 Σ납입액→OTHER_8403. OUT ×40% ↔ OTO_HOUSE_LOAN_SBSC_AMT. 실측(2026-07-18, 1,000,000→400,000)" },
  { group: "그밖의소득공제", ntsCode: "8407", label: "주택청약종합저축",          ytsCol: "OTHER_8407", resultCol: "OTO_HOUSE_LOAN_ALL_AMT", valueKey: "useAmt", rule: "value", status: "진행", send: true, note: "IN=PEN_SAVE_SPEC CLS 562-060 Σ납입액→OTHER_8407. 국세청 입력코드=8407(카탈로그 2015이후 주택청약종합저축). 구 ntsCode 8405+sendCode 8407 → 8407 단일화(2026-07-21). 8405로 보내면 OUT=0, 8407로 보내면 NTS가 8405·8407 둘 다 동일 ddcAmt 회신(과표 1회) — 한도미달(X202600086)·한도초과(X202600493) 2건 8405=8407 실측(hometax-housingsavings-probe). OUT ×40% ↔ OTO_HOUSE_LOAN_ALL_AMT" },
  { group: "그밖의소득공제", ntsCode: "8404", label: "근로자주택마련저축",         ytsCol: "OTHER_8404", resultCol: "OTO_HOUSE_LOAN_WRK_AMT",  valueKey: "useAmt", rule: "value", status: "진행", send: true, note: "IN=PEN_SAVE_SPEC CLS 562-080 Σ납입액→OTHER_8404. OUT ×40% ↔ OTO_HOUSE_LOAN_WRK_AMT. 실측(2026-07-18, 500,000→200,000)" },
  ...
  { group: "그밖의소득공제", ntsCode: "8416", label: "벤처등", ytsCol: "OTHER_8416", valueKey: "useAmt", rule: "value", status: "진행", send: true, yearOffset: -2, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8415", label: "조합1", ytsCol: "OTHER_8415", valueKey: "useAmt", rule: "value", status: "진행", send: true, yearOffset: -2, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8421", label: "조합2", ytsCol: "OTHER_8421", valueKey: "useAmt", rule: "value", status: "진행", send: true, yearOffset: -2, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8418", label: "벤처등", ytsCol: "OTHER_8418", valueKey: "useAmt", rule: "value", status: "진행", send: true, yearOffset: -1, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8417", label: "조합1", ytsCol: "OTHER_8417", valueKey: "useAmt", rule: "value", status: "진행", send: true, yearOffset: -1, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8422", label: "조합2", ytsCol: "OTHER_8422", valueKey: "useAmt", rule: "value", status: "진행", send: true, yearOffset: -1, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8420", label: "벤처등", ytsCol: "OTHER_8420", valueKey: "useAmt", rule: "value", status: "진행", send: true, yearOffset: 0, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8419", label: "조합1", ytsCol: "OTHER_8419", valueKey: "useAmt", rule: "value", status: "진행", send: true, yearOffset: 0, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8423", label: "조합2", ytsCol: "OTHER_8423", valueKey: "useAmt", rule: "value", status: "진행", send: true, yearOffset: 0, selfComparable: true, displaySubtotal: "8410" },
  ...
  { group: "그밖의소득공제", ntsCode: "8453", label: "고용유지중소기업근로자소득공제",  ytsCol: "OTHER_8453", resultCol: "OTO_EMPL_MTN_WAGE_CUT",  valueKey: "useAmt", rule: "value", status: "진행", send: true, tab: "기타", note: "IN=PAY_WRK_MAIN.EMPL_MTN_WAGE_CUT(임금삭감액)→OTHER_8453. OUT self ×50%(한도1000만) ↔ OTO_EMPL_MTN_WAGE_CUT. 라이브 캡처 실측(2026-07-19, 4,000,000→2,000,000)" },
