...
export const MAPPING_2025: MappingRow[] = [
  ...
  { group: "인적공제", ntsCode: "8002", label: "기본공제-배우자",   ytsCol: "FAM_8002",   resultCol: "BASC_SUB_MATE_AMT",   valueKey: "incDdcNfpCnt", rule: "value",   status: "완료", doneSeq: 14, send: true, inSource: { table: "PAY_WRK_FMLY", where: "FMLY_RELN='550-040' AND BAS_SUB_YN='Y'", agg: "count" }, note: "인원=원천 PAY_WRK_FMLY 재집계(FMLY_RELN 550-040·BAS_SUB_YN='Y' 카운트, injectFamilyVals FAM_8002)로 전환(2026-08-05) — 엔진 배우자판정(구 flag BASC_SUB_MATE_AMT) 대신 원천 독립집계로 국세청 대조(본인 제외 인적공제 원천통일). OUT self ddcAmt=1,500,000 ↔ resultCol BASC_SUB_MATE_AMT" },
  { group: "인적공제", ntsCode: "8003", label: "기본공제-부양가족(통합)", ytsCol: "BASC_SUB_FAMILY_CNT", resultCol: "BASC_SUB_FAMILY_AMT", valueKey: "incDdcNfpCnt", rule: "value",  status: "완료", doneSeq: 14, send: false, altSent: true, note: "IN은 8004~8009 유형별로 전송(8003 미전송)하나, ★국세청 OUT은 8003(통합)에 회신 → 부양가족은 8003 소계형 대조. YTS BASC_SUB_FAMILY_AMT(인원×150만) ↔ NTS 8003 OUT. 라이브 실측(2026-07-22 X202600219: 5명 7,500,000 일치)" },
  ...
  { group: "인적공제", ntsCode: "8004", label: "부양가족-직계존속",              ytsCol: "FAM_8004", valueKey: "incDdcNfpCnt", rule: "value", status: "완료", doneSeq: 14, send: true, inSource: { table: "PAY_WRK_FMLY", where: "FMLY_RELN IN ('550-020','550-030') AND BAS_SUB_YN='Y'", agg: "count" }, displaySubtotal: "8003", note: "FMLY_RELN 550-020(소득자 직계존속)+550-030(배우자 직계존속)" },
  { group: "인적공제", ntsCode: "8005", label: "부양가족-직계비속(자녀·손자녀·입양)", ytsCol: "FAM_8005", valueKey: "incDdcNfpCnt", rule: "value", status: "완료", doneSeq: 14, send: true, inSource: { table: "PAY_WRK_FMLY", where: "FMLY_RELN='550-050' AND BAS_SUB_YN='Y'", agg: "count" }, displaySubtotal: "8003", note: "FMLY_RELN 550-050" },
  { group: "인적공제", ntsCode: "8006", label: "부양가족-직계비속 그외",          ytsCol: "FAM_8006", valueKey: "incDdcNfpCnt", rule: "value", status: "완료", doneSeq: 14, send: true, inSource: { table: "PAY_WRK_FMLY", where: "FMLY_RELN='550-055' AND BAS_SUB_YN='Y'", agg: "count" }, displaySubtotal: "8003", note: "FMLY_RELN 550-055" },
  { group: "인적공제", ntsCode: "8007", label: "부양가족-형제자매",              ytsCol: "FAM_8007", valueKey: "incDdcNfpCnt", rule: "value", status: "완료", doneSeq: 14, send: true, inSource: { table: "PAY_WRK_FMLY", where: "FMLY_RELN='550-060' AND BAS_SUB_YN='Y'", agg: "count" }, displaySubtotal: "8003", note: "FMLY_RELN 550-060" },
  { group: "인적공제", ntsCode: "8008", label: "부양가족-수급자",                ytsCol: "FAM_8008", valueKey: "incDdcNfpCnt", rule: "value", status: "완료", doneSeq: 14, send: true, inSource: { table: "PAY_WRK_FMLY", where: "FMLY_RELN='550-070' AND BAS_SUB_YN='Y'", agg: "count" }, displaySubtotal: "8003", note: "FMLY_RELN 550-070" },
  { group: "인적공제", ntsCode: "8009", label: "부양가족-위탁아동",              ytsCol: "FAM_8009", valueKey: "incDdcNfpCnt", rule: "value", status: "완료", doneSeq: 14, send: true, inSource: { table: "PAY_WRK_FMLY", where: "FMLY_RELN='550-080' AND BAS_SUB_YN='Y'", agg: "count" }, displaySubtotal: "8003", note: "FMLY_RELN 550-080" },
  { group: "인적공제", ntsCode: "8101", label: "추가공제-경로우대", ytsCol: "ADD_SUB_OAT_CNT",     resultCol: "ADD_SUB_OAT_AMT",      valueKey: "incDdcNfpCnt", rule: "value",  status: "완료", doneSeq: 14, send: true, note: "self ddcAmt=인원×100만. 인원(ADD_SUB_OAT_CNT) 전송, 결과대조=ADD_SUB_OAT_AMT. 라이브 캡처 실측(2026-07-18, n=38, 1명→1,000,000)" },
  { group: "인적공제", ntsCode: "8102", label: "추가공제-장애인",   ytsCol: "ADD_SUB_HDC_PERS_CNT",resultCol: "ADD_SUB_HDC_PERS_AMT", valueKey: "incDdcNfpCnt", rule: "value",  status: "완료", doneSeq: 14, send: true, note: "self ddcAmt=인원×200만. 인원(ADD_SUB_HDC_PERS_CNT) 전송, 결과대조=ADD_SUB_HDC_PERS_AMT. 라이브 캡처 실측(2026-07-18, n=38, 2명→4,000,000)" },
  { group: "인적공제", ntsCode: "8103", label: "추가공제-부녀자",   ytsCol: "ADD_SUB_LADY_AMT",    resultCol: "ADD_SUB_LADY_AMT",      valueKey: "incDdcNfpCnt", rule: "flag",   status: "완료", doneSeq: 14, send: true, note: "self ddcAmt=500,000(50만). 인원(flag→1) 전송, 결과대조=ADD_SUB_LADY_AMT. 라이브 캡처 실측(2026-07-18, n=56, 배우자없음+직계비속0+부녀자로 격리 — 한부모(8104)와 배타관계)" },
  { group: "인적공제", ntsCode: "8104", label: "추가공제-한부모",   ytsCol: "ADD_SUB_SNGL_PRNT_AMT",resultCol: "ADD_SUB_SNGL_PRNT_AMT", valueKey: "incDdcNfpCnt", rule: "flag",  status: "완료", doneSeq: 14, send: true, note: "self ddcAmt=1,000,000(100만). 인원(flag→1) 전송, 결과대조=ADD_SUB_SNGL_PRNT_AMT. 라이브 캡처 실측(2026-07-18, n=46/47, 배우자없음+직계비속 → 한부모 자동 적용)" },
  ...
  { group: "특별소득공제", ntsCode: "8301", label: "건강보험료",   ytsCol: "SPCL_IF_HLTH_INSU_OBJ_AMT", resultCol: "SPCL_IF_HLTH_INSU_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  { group: "특별소득공제", ntsCode: "8305", label: "고용보험료",   ytsCol: "SPCL_IF_EMP_INSU_OBJ_AMT",  resultCol: "SPCL_IF_EMP_INSU_AMT",  valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  ...
  { group: "특별소득공제", ntsCode: "8311", label: "주택임차 원리금-대출기관",       ytsCol: "LOAN_8311", resultCol: "SP_HOUSE_RALR_LENDER_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  { group: "특별소득공제", ntsCode: "8312", label: "주택임차 원리금-거주자",         ytsCol: "LOAN_8312", resultCol: "SP_HOUSE_RALR_HABT_AMT",   valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true, inSource: { table: "PAY_WRK_RENT_HABT_SPEC", field: "PNINT_SUM", where: "RENT_HABT_CLS='B0'", agg: "sum" }, note: "PAY_WRK_RENT_HABT_SPEC B0 SUM(PNINT_SUM)(원본 원리금상환액 독립재집계) 주입 — NTS가 40%·한도(400만) 자체계산. MAIN 집계 대신 SPEC 상세 B0로 재집계(8311 대출기관=MAIN과 달리 거주자만 SPEC, injectHousingVals 서브쿼리)해 집계오류까지 대조로 표면화. 월세 8750(A0·HOUSE_RENT)과 동형(2026-07-23 실측정정)" },
  { group: "특별소득공제", ntsCode: "8321", label: "장기주택저당 2011이전 15년미만",        ytsCol: "LOAN_8321", resultCol: "SP_LH_LRSF1_AMT",  valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  { group: "특별소득공제", ntsCode: "8322", label: "장기주택저당 2011이전 15~29년",        ytsCol: "LOAN_8322", resultCol: "SP_LH_LRSF2_AMT",  valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  { group: "특별소득공제", ntsCode: "8323", label: "장기주택저당 2011이전 30년이상",        ytsCol: "LOAN_8323", resultCol: "SP_LH_LRSF3_AMT",  valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  { group: "특별소득공제", ntsCode: "8324", label: "장기주택저당 2011이전 15년이상 고정&비거치", ytsCol: "LOAN_8324", resultCol: "SP_LH_LRSF10_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  { group: "특별소득공제", ntsCode: "8325", label: "장기주택저당 2011이전 15년이상 고정or비거치",              ytsCol: "LOAN_8325", resultCol: "SP_LH_LRSF20_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  { group: "특별소득공제", ntsCode: "8326", label: "장기주택저당 2012이후 15년이상 고정&비거치", ytsCol: "LOAN_8326", resultCol: "SP_LH_LRSF30_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  { group: "특별소득공제", ntsCode: "8327", label: "장기주택저당 2012이후 15년이상 고정or비거치", ytsCol: "LOAN_8327", resultCol: "SP_LH_LRSF40_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  { group: "특별소득공제", ntsCode: "8328", label: "장기주택저당 2012이후 15년이상 그밖",         ytsCol: "LOAN_8328", resultCol: "SP_LH_LRSF50_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },
  { group: "특별소득공제", ntsCode: "8329", label: "장기주택저당 2012이후 10~15년",             ytsCol: "LOAN_8329", resultCol: "SP_LH_LRSF60_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 16, send: true },

  // ── 그밖의 소득공제 (useAmt) — 국세청 화면(그밖의소득공제 상세팝업) 기준 정리 (2026-07-17 화면·payload 실측) ──
  { group: "그밖의소득공제", ntsCode: "8401", label: "개인연금저축",              ytsCol: "OTHER_8401", resultCol: "OTO_PPF", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-030'", agg: "sum" }, tab: "기타", note: "IN=PAY_WRK_PEN_SAVE_SPEC PEN_SAVE_CLS='562-030' ΣPEN_SAVE_PMT_AMT(납입액 원본) → OTHER_8401 주입. OUT self ddcAmt=납입액×40%(한도72만) ↔ OTO_PPF. 라이브 캡처 실측(2026-07-18, 1,000,000→400,000). ★한도캡(납입>180만) 시 ddcLmtAmt 없이 NTS 자체캡 720,000 실측확정(2026-08-03, Y202600235 납입6,060,000→720,000, docs/ppf-8401-cap-probe.mjs)" },
  { group: "그밖의소득공제", ntsCode: "8402", label: "소기업소상공인", ytsCol: "OTHER_8402", resultCol: "OTO_SM_ETPR_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_MAIN", field: "SM_ETPR_AMT" }, tab: "기타", note: "IN=PAY_WRK_MAIN.SM_ETPR_AMT(납입액 원본) → OTHER_8402 주입. OUT self ddcAmt=min(납입액, 소득금액별한도 600/500/400/200만) ↔ OTO_SM_ETPR_AMT. 라이브 캡처 실측(2026-07-18, 1,000,000→1,000,000). ★한도캡 시 ddcLmtAmt 없이 NTS 자체캡 실측확정(2026-08-03, Y202600235 총급여1.5억→200만한도, 납입7,500,000→2,000,000, docs/sm-etpr-8402-cap-probe.mjs) + 구간표 600/500/400/200만 스윕확정(경계 소득금액 4천만·1억, docs/sm-etpr-8402-bracket-sweep.mjs)" },
  ...
  { group: "그밖의소득공제", ntsCode: "8403", label: "청약저축",                ytsCol: "OTHER_8403", resultCol: "OTO_HOUSE_LOAN_SBSC_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-050'", agg: "sum" }, note: "IN=PEN_SAVE_SPEC CLS 562-050 Σ납입액→OTHER_8403. OUT ×40% ↔ OTO_HOUSE_LOAN_SBSC_AMT. 실측(2026-07-18, 1,000,000→400,000)" },
  { group: "그밖의소득공제", ntsCode: "8407", label: "주택청약종합저축",          ytsCol: "OTHER_8407", resultCol: "OTO_HOUSE_LOAN_ALL_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-060'", agg: "sum" }, note: "IN=PEN_SAVE_SPEC CLS 562-060 Σ납입액→OTHER_8407. 국세청 입력코드=8407(카탈로그 2015이후 주택청약종합저축). 구 ntsCode 8405+sendCode 8407 → 8407 단일화(2026-07-21). 8405로 보내면 OUT=0, 8407로 보내면 NTS가 8405·8407 둘 다 동일 ddcAmt 회신(과표 1회) — 한도미달(X202600086)·한도초과(X202600493) 2건 8405=8407 실측(hometax-housingsavings-probe). OUT ×40% ↔ OTO_HOUSE_LOAN_ALL_AMT" },
  { group: "그밖의소득공제", ntsCode: "8404", label: "근로자주택마련저축",         ytsCol: "OTHER_8404", resultCol: "OTO_HOUSE_LOAN_WRK_AMT",  valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-080'", agg: "sum" }, note: "IN=PEN_SAVE_SPEC CLS 562-080 Σ납입액→OTHER_8404. OUT ×40% ↔ OTO_HOUSE_LOAN_WRK_AMT. 실측(2026-07-18, 500,000→200,000)" },
  ...
  { group: "그밖의소득공제", ntsCode: "8416", label: "벤처등", ytsCol: "OTHER_8416", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-110' AND INVST_CLS='2'", agg: "sum" },yearOffset: -2, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8415", label: "조합1", ytsCol: "OTHER_8415", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-110' AND INVST_CLS='1'", agg: "sum" },yearOffset: -2, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8421", label: "조합2", ytsCol: "OTHER_8421", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-110' AND INVST_CLS='3'", agg: "sum" },yearOffset: -2, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8418", label: "벤처등", ytsCol: "OTHER_8418", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-110' AND INVST_CLS='2'", agg: "sum" },yearOffset: -1, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8417", label: "조합1", ytsCol: "OTHER_8417", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-110' AND INVST_CLS='1'", agg: "sum" },yearOffset: -1, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8422", label: "조합2", ytsCol: "OTHER_8422", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-110' AND INVST_CLS='3'", agg: "sum" },yearOffset: -1, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8420", label: "벤처등", ytsCol: "OTHER_8420", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-110' AND INVST_CLS='2'", agg: "sum" },yearOffset: 0, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8419", label: "조합1", ytsCol: "OTHER_8419", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-110' AND INVST_CLS='1'", agg: "sum" },yearOffset: 0, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8423", label: "조합2", ytsCol: "OTHER_8423", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-110' AND INVST_CLS='3'", agg: "sum" },yearOffset: 0, selfComparable: true, displaySubtotal: "8410" },
  { group: "그밖의소득공제", ntsCode: "8410", label: "투자조합출자 소계", ytsCol: null, resultCol: "OTO_IU_ETC", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: false, note: "소계 결과전용(send:false). NTS OUT 8410=Σ개별(8415~8423) ddcAmt·과표 1회 반영 — 개별도 self ddcAmt 반환(하이브리드). 프로브 hometax-investment-probe(2026-07-21): 8420 1천만+8418 8백만→8410 1,800만, 벤처당해100%·조합1 10% 실측. 대조 OTO_IU_ETC(YTS 투자조합 공제 합). runHometaxCalc ALL_CODES에 8410 포함해 소계 결과 수신." },
  ...
  { group: "그밖의소득공제", ntsCode: "8452", label: "우리사주출연금 소득공제",       ytsCol: "OTHER_8452", resultCol: "OTO_SU",                 valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_MAIN", field: "STOCK_URDM" }, tab: "기타", note: "IN=PAY_WRK_MAIN.STOCK_URDM→OTHER_8452. OUT self 전액(한도1500만) ↔ OTO_SU. 라이브 캡처 실측(2026-07-19, 1,000,000→1,000,000)" },
  { group: "그밖의소득공제", ntsCode: "8451", label: "장기집합투자증권저축",          ytsCol: "OTHER_8451", resultCol: "OTO_LONG_STOCK_SAVING",   valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-100'", agg: "sum" }, tab: "기타", note: "IN=PEN_SAVE_SPEC CLS 562-100 Σ납입액→OTHER_8451. OUT self ×40%(한도240만) ↔ OTO_LONG_STOCK_SAVING. 라이브 캡처 실측(2026-07-19, 2,000,000→800,000)" },
  { group: "그밖의소득공제", ntsCode: "8501", label: "청년형 장기집합투자증권저축",     ytsCol: "OTHER_8501", resultCol: "OTO_YM_LONG_STOCK_SAVING", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_PEN_SAVE_SPEC", field: "PEN_SAVE_PMT_AMT", where: "PEN_SAVE_CLS='562-140'", agg: "sum" }, tab: "기타", note: "IN=PEN_SAVE_SPEC CLS 562-140 Σ납입액→OTHER_8501. OUT self ×40%(한도240만) ↔ OTO_YM_LONG_STOCK_SAVING. 카탈로그 미등재 코드였음, 라이브 캡처 실측(2026-07-19, 3,000,000→1,200,000)" },
  { group: "그밖의소득공제", ntsCode: "8453", label: "고용유지중소기업근로자소득공제",  ytsCol: "OTHER_8453", resultCol: "OTO_EMPL_MTN_WAGE_CUT",  valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 18, send: true, inSource: { table: "PAY_WRK_MAIN", field: "EMPL_MTN_WAGE_CUT" }, tab: "기타", note: "IN=PAY_WRK_MAIN.EMPL_MTN_WAGE_CUT(임금삭감액)→OTHER_8453. OUT self ×50%(한도1000만) ↔ OTO_EMPL_MTN_WAGE_CUT. 라이브 캡처 실측(2026-07-19, 4,000,000→2,000,000)" },
  ...
  { group: "세액공제", ntsCode: "8763", label: "자녀세액공제",  ytsCol: "CHLD", resultCol: "RT_HWC_AMT", valueKey: "incDdcNfpCnt", rule: "value", status: "완료", doneSeq: 5, send: true, inSource: { table: "PAY_WRK_FMLY", where: "CHILD_YN='Y' AND FMLY_RELN IN ('550-050','550-080')", agg: "count" }, depNote: "산출에 직계비속(8005) 인원 동반 전송 필수 — 8005=0이면 8763도 0(유형별+총인원 둘 다 필요).", note: "★총인원을 RT_HWC_CNT(세액계산SW 중간값) 대신 PAY_WRK_FMLY 원천 독립재집계(CHLD: CHILD_YN='Y'·직계비속550-050/위탁아동550-080 카운트)로 전송 — 자녀 인원 집계오류까지 국세청 대조로 표면화(월세 SPEC 전환과 동형, 2026-08-04). 8004~8009(유형별)만으론 8763=0 → 유형별+총인원 둘 다 있어야 산출(8~20세 조건이라 국세청이 직계비속 수만으론 미판단). 2026-07-17 실측 정정" },
  ...
  { group: "세액공제", ntsCode: "8764", label: "출산입양-첫째",     ytsCol: "FAM_8764", resultCol: "RT_PER_CHI_AMT", valueKey: "incDdcNfpCnt", rule: "value", status: "완료", doneSeq: 6, send: true, outCode: "8761", inSource: { table: "PAY_WRK_FMLY", where: "PER_CHI_YN='3' AND FMLY_RELN='550-050'", agg: "count" }, note: "PER_CHI_YN=3(30만). OUT은 소계 8761에 합산. resultCol=소계 총액(카드 OTO_CARD_ETC·의료 RT_MEDI_AMT 동형)→ytsDdcMap[8761] 대조(국세청 소진캡 vs YTS 엔진캡, 2026-07-25)" },
  { group: "세액공제", ntsCode: "8765", label: "출산입양-둘째",     ytsCol: "FAM_8765", resultCol: "RT_PER_CHI_AMT", valueKey: "incDdcNfpCnt", rule: "value", status: "완료", doneSeq: 6, send: true, outCode: "8761", inSource: { table: "PAY_WRK_FMLY", where: "PER_CHI_YN='5' AND FMLY_RELN='550-050'", agg: "count" }, note: "PER_CHI_YN=5(50만). OUT은 소계 8761에 합산. resultCol=소계 총액" },
  { group: "세액공제", ntsCode: "8766", label: "출산입양-셋째이상", ytsCol: "FAM_8766", resultCol: "RT_PER_CHI_AMT", valueKey: "incDdcNfpCnt", rule: "value", status: "완료", doneSeq: 6, send: true, outCode: "8761", inSource: { table: "PAY_WRK_FMLY", where: "PER_CHI_YN='7' AND FMLY_RELN='550-050'", agg: "count" }, note: "PER_CHI_YN=7(70만). OUT은 소계 8761에 합산. resultCol=소계 총액" },

  // ── 세액공제: 보험료 (전송=공제대상금액 SPCL_*) ────────────────────────────
  { group: "세액공제", ntsCode: "8710", label: "보장성보험료",        ytsCol: "INS_GRT", resultCol: "RT_IF_GRT_INSU_AMT",      valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 2, send: true, inSource: { table: "PAY_WRK_FMLY_DTL", field: "GRT_INSU", agg: "sum" }, note: "★원본 지출총액(PAY_WRK_FMLY_DTL SUM(GRT_INSU)→INS_GRT) 전송. 국세청이 100만 한도 self cap(2026-07-25 구분프로브 실측: useAmt=원본 20,191,680·ddcLmtAmt=0 전송→OUT 120,000=100만×12%, no-cap 2,423,002 아님) → NTS self OUT ddcAmt=12% ↔ RT_IF_GRT_INSU_AMT 원단위 일치. 원본전송으로 한도로직 교차검증. 구 SPCL_IF_GRT_INSU_AMT(100만 capped) 전송 폐기: 한도 검증 사각이었음" },
  { group: "세액공제", ntsCode: "8711", label: "장애인전용 보장성보험료", ytsCol: "INS_HDC", resultCol: "RT_IF_HDC_PERS_INSU_AMT", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 3, send: true, inSource: { table: "PAY_WRK_FMLY_DTL", field: "HDC_PERS_INSU", agg: "sum" }, note: "★원본 지출총액(PAY_WRK_FMLY_DTL SUM(HDC_PERS_INSU)→INS_HDC) 전송. 국세청 100만 self cap(2026-07-25 실측: 원본 1,525,400→OUT 150,000=100만×15%) → NTS OUT ddcAmt=15% ↔ RT_IF_HDC_PERS_INSU_AMT 일치. 8710과 독립 self. 구 SPCL_IF capped 전송 폐기" },
  ...
  // ── 기부금 — 유형별(당해분 + 이월분 인접). PAY_WRK_GIFT/GIFT_ADJ → GIFT_{코드} 가상컬럼으로 주입 ──
  { group: "기부금", ntsCode: "8740", label: "정치자금기부금",    ytsCol: "GIFT_8740", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true,  note: "전액 8740 전송 → NTS가 10만 이하/초과 자동분리(8741 별도전송 금지). OUT self 8740=전체공제액(10만이하 100/110+초과 15%), 8741=10만이하 소계. 실측확정 2026-07-16" },
  { group: "기부금", ntsCode: "8783", label: "고향사랑기부금(일반)",       ytsCol: "GIFT_8783", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8784", label: "고향사랑기부금(특별재난)",   ytsCol: "GIFT_8784", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8743", label: "특례기부금 당해",           ytsCol: "GIFT_8743", resultCol: "RT_DON_LAW",    valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8811", label: "특례기부금 이월(-1년)",       ytsCol: "GIFT_8811", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8812", label: "특례기부금 이월(-2년)",       ytsCol: "GIFT_8812", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8813", label: "특례기부금 이월(-3년)",       ytsCol: "GIFT_8813", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8814", label: "특례기부금 이월(-4년)",       ytsCol: "GIFT_8814", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8815", label: "특례기부금 이월(-5년)",       ytsCol: "GIFT_8815", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8744", label: "우리사주조합 기부금",        ytsCol: "GIFT_8744", resultCol: "RT_STOCK_URSM", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8746", label: "일반기부금(종교) 당해",        ytsCol: "GIFT_8746", resultCol: "RT_PSA_RELGN",  valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8821", label: "일반기부금(종교) 이월(-1년)",  ytsCol: "GIFT_8821", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8822", label: "일반기부금(종교) 이월(-2년)",  ytsCol: "GIFT_8822", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8823", label: "일반기부금(종교) 이월(-3년)",  ytsCol: "GIFT_8823", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8824", label: "일반기부금(종교) 이월(-4년)",  ytsCol: "GIFT_8824", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8825", label: "일반기부금(종교) 이월(-5년)",  ytsCol: "GIFT_8825", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8747", label: "일반기부금(종교외) 당해",     ytsCol: "GIFT_8747", resultCol: "RT_PSA",         valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8831", label: "일반기부금(종교외) 이월(-1년)", ytsCol: "GIFT_8831", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8832", label: "일반기부금(종교외) 이월(-2년)", ytsCol: "GIFT_8832", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8833", label: "일반기부금(종교외) 이월(-3년)", ytsCol: "GIFT_8833", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8834", label: "일반기부금(종교외) 이월(-4년)", ytsCol: "GIFT_8834", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
  { group: "기부금", ntsCode: "8835", label: "일반기부금(종교외) 이월(-5년)", ytsCol: "GIFT_8835", valueKey: "useAmt", rule: "value", status: "완료", doneSeq: 17, send: true },
...
/**
 * 계산과정(CALC_PROC_TOTAL) 텍스트의 `(잔액)` 항목행 라벨 → NTS 코드 (2025 귀속, **등장 순서대로**).
 *
 * ▶ 목적: 실행과정 ③표(NTS 원본 IN/OUT)를 계산과정과 **같은 순서**로 세워 좌우 대조를 쉽게 한다.
 *   계산과정은 세액계산 SW가 찍는 고정 템플릿(65줄)이라, 이 사전이 곧 표시 순서의 단일 원천.
 * ▶ key = 계산과정에 찍히는 라벨 **원문 그대로**(내부 괄호 포함). MAPPING_2025.label 과 다를 수 있음
 *   (계산과정은 소계 한 줄만, 매핑은 개별행). 소계형(카드/의료/교육/투자조합)은 소계코드로 매핑.
 * ▶ 매년 관리: 직전연도 복사 후 계산과정 실측(docs/proc-order-probe.mjs)으로 라벨 변화만 갱신.
 * ▶ status 추정(주석 ※): 계산과정 라벨과 코드 축이 어긋나거나 소계코드 미확정 — 라이브 확인 대상.
 */
export const PROC_LABEL_CODE_2025: Record<string, string> = {
  // 소득공제 — 인적공제
  "본인": "8001",
  "배우자": "8002",
  "부양가족": "8003",
  ...
  "건강보험료": "8301",
  "고용보험료": "8305",
  "주택임차차입금원리금상환액(대출기관)": "8311",
  "주택임차차입금원리금상환액(거주자)": "8312",
  "2011년이전:상환15년미만": "8321",
  "2011년이전:상환15년∼29년": "8322",
  "2011년이전:상환30년이상": "8323",
  "2011년이전(15년이상):고정and비거치식": "8324",
  "2011년이전(15년이상):고정or비거치식": "8325",
  "2012년이후(15년이상):고정and비거치": "8326",
  "2012년이후(15년이상):고정or비거치": "8327",
  "2012년이후(15년이상):그밖의대출": "8328",
  "2012년이후(10년∼15년):고정or비거치": "8329",
  // 소득공제 — 그밖의소득공제
  "개인연금저축": "8401",
  "소기업·소상공인공제부금": "8402",
  "청약저축": "8403",
  ...
  "조특법(30조)": "8603",                 // ★계산과정 라벨 "조특법(30조)"=RT_R_LAW_CLAUS30 소계 → 소계코드 8603 과 대조(procLineClass). 드로어 상단 헤더
  "조특법30조-중소기업취업 90%": "8608",   // 개별(rosterOrder·③표 그룹용; 계산과정 텍스트엔 세부 라벨 없어 procLineClass 무관)
  "조특법30조-중소기업취업 70%": "8607",
  "조특법(30조제외)": "8620",             // ★계산과정 라벨 "조특법(30조제외)"=RT_R_LAW 소계 → 소계코드 8620 과 대조. 드로어 상단 헤더
  "조특법30조제외-외국인기술자 50%": "8602",   // 개별
  ...
  "정치자금기부금-10만원이하": "8741",   // ※8741=10만이하소계 추정, self대조는 8740
  "정치자금기부금-10만원초과": "8740",
  "고향사랑기부금-10만원이하(일반+특별)": "8783",   // ※금액대 vs 일반/특별 축 불일치, 앵커용 추정
  "고향사랑기부금-10만원초과(특별)": "8784",
  "고향사랑기부금-10만원초과(일반)": "8783",
  "납세조합공제": "8753",
  "주택차입금이자상환액": "8752",
  "월세액": "8750",
  "특례기부금": "8743",
