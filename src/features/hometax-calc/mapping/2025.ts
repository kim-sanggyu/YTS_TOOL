...
export const MAPPING_2025: MappingRow[] = [
  ...
  { group: "세액공제", ntsCode: "8763", label: "자녀세액공제",  ytsCol: "RT_HWC_CNT",     resultCol: "RT_HWC_AMT",     valueKey: "incDdcNfpCnt", rule: "value", status: "진행", send: true, note: "★총인원(RT_HWC_CNT) 필수 전송. 8004~8009(유형별)만으론 8763=0 → 유형별+총인원 둘 다 있어야 산출(8~20세 조건이라 국세청이 직계비속 수만으론 미판단). 2026-07-17 실측 정정" },
  ...
  { group: "세액공제", ntsCode: "8764", label: "출산입양-첫째",     ytsCol: "FAM_8764", resultCol: "RT_PER_CHI_AMT", valueKey: "incDdcNfpCnt", rule: "value", status: "진행", send: true, outCode: "8761", note: "PER_CHI_YN=3(30만). OUT은 소계 8761에 합산. resultCol=소계 총액(카드 OTO_CARD_ETC·의료 RT_MEDI_AMT 동형)→ytsDdcMap[8761] 대조(국세청 소진캡 vs YTS 엔진캡, 2026-07-25)" },
  { group: "세액공제", ntsCode: "8765", label: "출산입양-둘째",     ytsCol: "FAM_8765", resultCol: "RT_PER_CHI_AMT", valueKey: "incDdcNfpCnt", rule: "value", status: "진행", send: true, outCode: "8761", note: "PER_CHI_YN=5(50만). OUT은 소계 8761에 합산. resultCol=소계 총액" },
  { group: "세액공제", ntsCode: "8766", label: "출산입양-셋째이상", ytsCol: "FAM_8766", resultCol: "RT_PER_CHI_AMT", valueKey: "incDdcNfpCnt", rule: "value", status: "진행", send: true, outCode: "8761", note: "PER_CHI_YN=7(70만). OUT은 소계 8761에 합산. resultCol=소계 총액" },
  ...
  { group: "기타세액공제", ntsCode: "8751", label: "외국납부_국외납부세액",  ytsCol: "ETX_8751", resultCol: "RT_FCG", valueKey: "useAmt", rule: "value", status: "진행", send: true, note: "PAY_WRK_MAIN.FRGN_PAY_TAX(국외납부세액,대상) → self ddcAmt ↔ RT_FCG. ★8754(국외총급여) 동반 필수(없으면 결과0, 한도=산출세액×국외소득/총급여)" },
