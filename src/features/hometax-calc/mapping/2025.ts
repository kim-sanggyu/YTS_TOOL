...
export const MAPPING_2025: MappingRow[] = [
  ...
  { group: "세액공제", ntsCode: "8754", label: "외국납부_국외총급여",   ytsCol: "ETX_8754", valueKey: "useAmt", rule: "value", status: "진행", send: true, outCode: "—", note: "외국납부세액공제 한도계산용 동반입력. 자체 결과 없음. PAY_WRK_MAIN.FRGN_TOT_PAY_AMT" },
  ...
  { group: "기부금", ntsCode: "8743", label: "특례(법정)기부금",           ytsCol: "GIFT_8743", resultCol: "RT_DON_LAW",    valueKey: "useAmt", rule: "value", status: "진행", send: true },
  ...
  { group: "기부금", ntsCode: "8746", label: "일반기부금-종교단체",        ytsCol: "GIFT_8746", resultCol: "RT_PSA_RELGN",  valueKey: "useAmt", rule: "value", status: "진행", send: true },
  { group: "기부금", ntsCode: "8747", label: "일반기부금-종교단체 외",     ytsCol: "GIFT_8747", resultCol: "RT_PSA",         valueKey: "useAmt", rule: "value", status: "진행", send: true },
