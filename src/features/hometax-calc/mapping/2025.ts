...
export const MAPPING_2025: MappingRow[] = [
  ...
  { group: "인적공제", ntsCode: "8001", label: "기본공제-본인",     ytsCol: null,                  resultCol: "BASC_SUB_SELF_AMT",  valueKey: "incDdcNfpCnt", rule: "const1", status: "진행", send: true, note: "self ddcAmt=1,500,000(본인 150만). 인원(incDdcNfpCnt=1) 전송. 라이브 payload 캡처 실측(capture-io 2026-07-18, n=38)" },
  { group: "인적공제", ntsCode: "8002", label: "기본공제-배우자",   ytsCol: "BASC_SUB_MATE_AMT",   resultCol: "BASC_SUB_MATE_AMT",   valueKey: "incDdcNfpCnt", rule: "flag",   status: "진행", send: true, note: "self ddcAmt=1,500,000(150만). 인원(flag→1) 전송, 결과대조=BASC_SUB_MATE_AMT. 라이브 payload 캡처 실측(2026-07-18, n=38)" },
  { group: "인적공제", ntsCode: "8003", label: "기본공제-부양가족(통합)", ytsCol: "BASC_SUB_FAMILY_CNT", resultCol: "BASC_SUB_FAMILY_AMT", valueKey: "incDdcNfpCnt", rule: "value",  status: "진행", send: false, altSent: true, note: "IN은 8004~8009 유형별로 전송(8003 미전송)하나, ★국세청 OUT은 8003(통합)에 회신 → 부양가족은 8003 소계형 대조. YTS BASC_SUB_FAMILY_AMT(인원×150만) ↔ NTS 8003 OUT. 라이브 실측(2026-07-22 X202600219: 5명 7,500,000 일치)" },
  ...
  { group: "인적공제", ntsCode: "8004", label: "부양가족-직계존속",              ytsCol: "FAM_8004", valueKey: "incDdcNfpCnt", rule: "value", status: "진행", send: true, displaySubtotal: "8003", note: "FMLY_RELN 550-020(소득자 직계존속)+550-030(배우자 직계존속)" },
  { group: "인적공제", ntsCode: "8005", label: "부양가족-직계비속(자녀·손자녀·입양)", ytsCol: "FAM_8005", valueKey: "incDdcNfpCnt", rule: "value", status: "진행", send: true, displaySubtotal: "8003", note: "FMLY_RELN 550-050" },
  { group: "인적공제", ntsCode: "8006", label: "부양가족-직계비속 그외",          ytsCol: "FAM_8006", valueKey: "incDdcNfpCnt", rule: "value", status: "진행", send: true, displaySubtotal: "8003", note: "FMLY_RELN 550-055" },
  { group: "인적공제", ntsCode: "8007", label: "부양가족-형제자매",              ytsCol: "FAM_8007", valueKey: "incDdcNfpCnt", rule: "value", status: "진행", send: true, displaySubtotal: "8003", note: "FMLY_RELN 550-060" },
  { group: "인적공제", ntsCode: "8008", label: "부양가족-수급자",                ytsCol: "FAM_8008", valueKey: "incDdcNfpCnt", rule: "value", status: "진행", send: true, displaySubtotal: "8003", note: "FMLY_RELN 550-070" },
  { group: "인적공제", ntsCode: "8009", label: "부양가족-위탁아동",              ytsCol: "FAM_8009", valueKey: "incDdcNfpCnt", rule: "value", status: "진행", send: true, displaySubtotal: "8003", note: "FMLY_RELN 550-080" },
  { group: "인적공제", ntsCode: "8101", label: "추가공제-경로우대", ytsCol: "ADD_SUB_OAT_CNT",     resultCol: "ADD_SUB_OAT_AMT",      valueKey: "incDdcNfpCnt", rule: "value",  status: "진행", send: true, note: "self ddcAmt=인원×100만. 인원(ADD_SUB_OAT_CNT) 전송, 결과대조=ADD_SUB_OAT_AMT. 라이브 캡처 실측(2026-07-18, n=38, 1명→1,000,000)" },
  { group: "인적공제", ntsCode: "8102", label: "추가공제-장애인",   ytsCol: "ADD_SUB_HDC_PERS_CNT",resultCol: "ADD_SUB_HDC_PERS_AMT", valueKey: "incDdcNfpCnt", rule: "value",  status: "진행", send: true, note: "self ddcAmt=인원×200만. 인원(ADD_SUB_HDC_PERS_CNT) 전송, 결과대조=ADD_SUB_HDC_PERS_AMT. 라이브 캡처 실측(2026-07-18, n=38, 2명→4,000,000)" },
  { group: "인적공제", ntsCode: "8103", label: "추가공제-부녀자",   ytsCol: "ADD_SUB_LADY_AMT",    resultCol: "ADD_SUB_LADY_AMT",      valueKey: "incDdcNfpCnt", rule: "flag",   status: "진행", send: true, note: "self ddcAmt=500,000(50만). 인원(flag→1) 전송, 결과대조=ADD_SUB_LADY_AMT. 라이브 캡처 실측(2026-07-18, n=56, 배우자없음+직계비속0+부녀자로 격리 — 한부모(8104)와 배타관계)" },
  { group: "인적공제", ntsCode: "8104", label: "추가공제-한부모",   ytsCol: "ADD_SUB_SNGL_PRNT_AMT",resultCol: "ADD_SUB_SNGL_PRNT_AMT", valueKey: "incDdcNfpCnt", rule: "flag",  status: "진행", send: true, note: "self ddcAmt=1,000,000(100만). 인원(flag→1) 전송, 결과대조=ADD_SUB_SNGL_PRNT_AMT. 라이브 캡처 실측(2026-07-18, n=46/47, 배우자없음+직계비속 → 한부모 자동 적용)" },
